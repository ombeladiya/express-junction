      ...
      <header className='w-full h-14 bg-white  flex justify-between shadow-md fixed top-0 z-50'>
        ...
        <div>
          <ul className='flex px-4 py-4'>
            <li className='mx-4 text-sm hover:text-zinc-700 hidden sm:block'><Link to='/addorder'>AddOrder</Link></li>
            <li className='mx-4 text-sm hover:text-zinc-700 hidden sm:block'><Link to='/admin/dashboard'>Dashboard</Link></li>
            <li className='mx-4 text-sm hover:text-zinc-700 hidden sm:block'><Link to='/'>Account</Link></li>
           
            <li className='mx-2 sm:mx-4 -my-1 text-sm'><Link to='/login'> <button
              type="button"
            ...
            <li className='mx-0 -my-1 text-sm sm:block hidden'><Link to='/signup'> <button
              type="button"
