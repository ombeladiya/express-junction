  ...
  return (
    <section className='min-h-screen mt-12'>
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="relative md:flex hidden items-end px-4  pt-60 sm:px-6 sm:pb-16 md:justify-center lg:px-8">
        ...
        <div className="flex items-center justify-center px-2 py-10 mt-20 sm:mt-1 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
