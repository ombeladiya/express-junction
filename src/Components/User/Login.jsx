  ...
  return (
    <section className='min-h-screen'>
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="relative md:flex hidden items-end px-4 pb-10 pt-60 sm:px-6 sm:pb-16 md:justify-center lg:px-8 lg:pb-24">
        ...
        <div className="flex items-center justify-center px-4 py-10 mt-20 sm:mt-1 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            <h2 className="text-2xl font-bold leading-tight text-black sm:text-3xl">Sign in</h2>
