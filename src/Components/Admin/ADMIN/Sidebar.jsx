...
function Sidebar() {
  ...
  return (
    <div className='w-1/5 min-h-screen bg-slate-100 '>
        ...
        <span className={`w-full h-10 ${path === '/admin/users' ? 'bg-gray-200' : ''} font-semibold  px-4 flex items-center`}><Link to='/admin/users'>Manage User</Link></span>
        <span className={`w-full h-10 ${path === '/admin/users' ? 'bg-gray-200' : ''} font-semibold  px-4 flex items-center`}><Link to='/admin/users'>Manage Orders</Link></span>
